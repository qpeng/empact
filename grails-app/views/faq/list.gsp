...
<%@ page import="empact.EndUser; empact.Faq" %>
<!DOCTYPE html>
<html>
<head>
...
<div class='container'>
    <!-- Title -->
    <h3 class="titleText inline">FAQs</h3>
    <g:if test="${session.user && (userType?.equals("Moderator") || userType?.equals("Superuser"))}">
        <a href="#newFAQ" class="btn btn-primary pull-right" data-toggle="modal" role="button">New FAQ</a>
    </g:if>
...
<div id="newFAQ" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h3 id="myModalLabel">Add a New FAQ</h3>
    </div>
